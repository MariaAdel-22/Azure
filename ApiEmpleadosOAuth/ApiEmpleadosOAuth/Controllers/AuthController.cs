...
namespace ApiEmpleadosOAuth.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        //NECESITAMOS UN METODO PARA VALIDAR EL USUARIO/PASSWORD Y QUE NECESITEN UN LOGINMODEL. LOS ENDPOINTS
        //DE VALIDACION SON POST

        [HttpPost]
        [Route("[action]")]
        public ActionResult Login(LoginModel model) {

            Empleado empleado = this.repo.ExisteEmpleado(model.UserName, model.Password);
            ...
            if (empleado == null)
            {
                ...
                //DEVOLVEMOS LA RESPUESTA CORRECTA CON EL TOKEN
                return Ok(new
                {
