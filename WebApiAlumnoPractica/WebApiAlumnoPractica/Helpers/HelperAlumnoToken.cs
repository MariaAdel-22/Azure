...
namespace WebApiAlumnoPractica.Helpers
{
    public class HelperAlumnoToken
    {
        public string Issuer { get; set; }
        public string Audience { get; set; }
        public string SecretKey { get; set; }

        public HelperAlumnoToken(IConfiguration configuration)
        {
            this.Issuer = configuration.GetValue<string>("ApiAlumno:Issuer");
            this.Audience = configuration.GetValue<string>("ApiAlumno:Audience");
            this.SecretKey = configuration.GetValue<string>("ApiAlumno:SecretKey");
        }
